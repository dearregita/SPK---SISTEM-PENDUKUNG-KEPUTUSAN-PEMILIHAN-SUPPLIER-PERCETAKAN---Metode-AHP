...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Perbaikan untuk menghindari error pada $IR
        $indexRandomConsistency = DB::table('index_random_consistency')->where('ukuran_matriks', $kriteria->count())->first();
        $IR = $indexRandomConsistency ? $indexRandomConsistency->nilai : null;
