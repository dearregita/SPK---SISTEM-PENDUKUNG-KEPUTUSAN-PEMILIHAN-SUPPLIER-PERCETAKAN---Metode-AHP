                    ...
                    <div class="flex justify-end items-center d p-4">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">                           
                                <label 
                                    for="add_button" 
                                    class="btn btn-primary btn-sm text-white dark:text-gray-800 normal-case bg-purple-600 hover:bg-opacity-70 hover:border-opacity-70 dark:bg-purple-300 dark:hover:bg-opacity-90 {{ count($data) >= 4 ? 'disabled:bg-gray-400 cursor-not-allowed' : '' }}"
                                    {{ count($data) >= 4 ? 'disabled' : '' }}>
    ...
    <script>
        @if(count($data) >= 4)
            Swal.fire({
                ...
                text: 'Anda hanya dapat menambahkan maksimal 4 data.',
                icon: 'info',
