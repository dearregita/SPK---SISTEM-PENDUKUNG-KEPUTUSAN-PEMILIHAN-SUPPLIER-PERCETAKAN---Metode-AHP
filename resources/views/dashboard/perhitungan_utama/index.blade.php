                                    ...
                                    @foreach ($matriksNilai->unique('kriteria_id') as $item)
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            @foreach ($matriksNilai->where('kriteria_id', $item->kriteria_id) as $value)
                                                <td class="px-4 py-3 text-lg">{{ round($value->nilai, 2) }}</td>
                                            @endforeach
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksNilai->where('kriteria_id', $item->kriteria_id)->sum('nilai'), 2) }}
                                            </td>
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksNilai->where('kriteria_id', $item->kriteria_id)->sum('nilai') / $matriksNilai->unique('kriteria_id')->count(), 2) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($matriksPenjumlahan->unique('kriteria_id') as $item)
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            @endforeach
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksPenjumlahan->where('kriteria_id', $item->kriteria_id)->sum('nilai'), 2) }}
                                            </td>
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksPenjumlahanPrioritas->where('kriteria_id', $item->kriteria_id)->first()->prioritas, 2) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($kriteria as $item)
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksPenjumlahan->where('kriteria_id', $item->id)->sum('nilai'), 2) }}
                                            </td>
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksNilai->where('kriteria_id', $item->id)->sum('nilai') / $matriksNilai->unique('kriteria_id')->count(), 2) }}
                                            </td>
                                            @php
                                                ...
                                                $hasil = round($jumlah + $prioritas, 2);
                                            @endphp
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($hasil, 2) }}
                                            </td>
                                            <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                                {{ round($matriksPenjumlahanPrioritas->where('kriteria_id', $item->id)->first()->prioritas, 2) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                    ...
                                    <tr>
                                        @php
                                            ...
                                            foreach ($kriteria as $item) {
                                                $jumlah = $matriksPenjumlahan->where('kriteria_id', $item->id)->sum('nilai');
                                                $prioritas = $matriksNilai->where('kriteria_id', $item->id)->sum('nilai') / $matriksNilai->unique('kriteria_id')->count();
                                                $hasilRasio += round($jumlah + $prioritas, 2);
                                            }
                                        @endphp
                                        <th scope="col" colspan="3" class="px-4 py-3 text-center">Jumlah</th>
                                        <th scope="col" colspan="2" class="px-4 py-3">{{ round($hasilRasio, 2) }}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
